...
class Config(object):
    ...
    def get_dataset_settings(self):
        ...
        self.dataset_settings['base_path'] = self.dataset_path
        # print('dataset_settings: ', self.dataset_settings)

    # get camera settings
    def get_cam_settings(self):
        self.cam_settings = None
        self.settings_doc = self.config_parser[self.dataset_type]['cam_settings']
    ...
    def camera(self):
        if not hasattr(self, '_camera'):
            # return PinholeCamera(self.cam_settings['Camera.width'], self.cam_settings['Camera.height'],
